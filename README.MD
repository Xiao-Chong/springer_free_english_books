## Add multithread support by python 3.2+ concurrent.futures lib

## Python script to download all english Springer books released for free during the 2020 COVID-19 quarantine
